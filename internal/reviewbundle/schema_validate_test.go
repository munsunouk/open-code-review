...
func TestValidateBundleDocumentAcceptsDeletedFileWithoutContentHash(t *testing.T) {
	document := []byte(`{
		...
		"contract":{"comment_schema":"codex-review-comments/v1","line_numbers":"one_based_new_file","allowed_priorities":["high","medium","low"],"allowed_categories":["bug","security","performance","concurrency","maintainability","test"],"max_bundle_bytes":4194304,"bundle_size_bytes":0,"requires_reflection":true}
	}`)
